...
import sunsetsatellite.catalyst.energy.improved.electric.test.block.BlockElectricBatteryBox;
import sunsetsatellite.catalyst.energy.improved.electric.test.block.BlockElectricGenerator;
import sunsetsatellite.catalyst.energy.improved.electric.test.block.BlockElectricMachine;
import sunsetsatellite.catalyst.energy.improved.electric.test.block.model.BlockModelCable;
import sunsetsatellite.catalyst.energy.improved.electric.test.block.model.BlockModelWithOverlay;
import turniplabs.halplibe.helper.BlockBuilder;

import static sunsetsatellite.catalyst.CatalystEnergy.LOGGER;
import static sunsetsatellite.catalyst.CatalystEnergy.MOD_ID;
import static sunsetsatellite.catalyst.energy.improved.electric.test.data.ElectricConfig.getBlockId;
