package sunsetsatellite.catalyst.energy.improved.electric.test.block.model;
...
public class BlockModelWithOverlay extends BlockModelStandard<Block> {
	...
	public BlockModelWithOverlay(Block block, String casing) {
		super(block);
		this.casing = TextureRegistry.getTexture("catalyst-energy:block/"+casing);
		withTextures("catalyst-energy:block/"+casing);
	}

	public BlockModelWithOverlay changeOverlay(Direction dir, String tex){
		overlays.put(dir,TextureRegistry.getTexture("catalyst-energy:block/"+tex));
		return this;
	}
